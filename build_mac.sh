...
CGO_ENABLED=0 GOOS=windows GOARCH=amd64 go build -o build/yuque_export_win_amd64
CGO_ENABLED=0 GOOS=windows GOARCH=arm64 go build -o build/yuque_export_win_arm64
